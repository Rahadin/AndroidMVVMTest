...
//    Pass argument as custom parcelable. Parcelable is Android’s recommended way of
//    passing your custom data structure between different components in your app
    constructor(parcel: Parcel) : this(
        parcel.readString(),
        parcel.readString(),
        parcel.readString()
...
data class AnimalPallete(var color: Int)